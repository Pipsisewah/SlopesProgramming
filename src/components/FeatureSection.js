            ...
            <div className="container px-6 py-8 mx-auto">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <div>
                        ...
                        <h1 className="mt-4 text-xl font-semibold text-gray-800 dark:text-white">Default Taiwindcss
                            Config</h1>

                        <p className="mt-2 text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur
                            adipiscing elit. Dignissim fusce tortor, ac sed malesuada blandit. Et mi gravida sem
                            feugiat.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h1 className="mt-4 text-xl font-semibold text-gray-800 dark:text-white">Fully Responsive
                            Components</h1>
                    ...
                    <div>
                        ...
                        <h1 className="mt-4 text-xl font-semibold text-gray-800 dark:text-white">RTL Languages
                            Support</h1>
